...
wd <- "/Users/hehardenbergh/books" # set working directory
setwd(wd)
...
metadata.df <- data.frame(read_csv('/Users/hehardenbergh/books/books.data/hierarchy_metadata.csv'))
...
### not sure why they use this setwd(wd) stuff...
...
for(j in 1:length(files)){
  ...
  nodes <- data.frame(read_csv(files[j]))
