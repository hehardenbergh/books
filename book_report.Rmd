...
ggsave(filename = "table_1.pdf", plot = tableGrob(table_1), path = "./figures/", width = 10, height = 10)
...
ggsave(filename = "figure_1.pdf", plot = fig_1, path = "./figures/", width = 7, height = 7)
```
...
ggsave(filename = "figure_2.pdf", plot = figure_2, path = "./figures/", width = 10, height = 10)
...
ggsave(filename = "table_2.pdf", plot = tableGrob(table_2), path = "./figures/", width = 10, height = 10)
...
ggsave(filename = "figure_3.pdf", plot = figure_3, path = "./figures/", width = 10, height = 10)
...
ggsave(filename = "figure_4.pdf", plot = figure_4, path = "./figures/", width = 10, height = 10)
